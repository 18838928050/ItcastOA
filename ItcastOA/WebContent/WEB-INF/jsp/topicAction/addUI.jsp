		...
		<center>
			...
			<div class="">
				<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
					<tr>
						<td class=""  width="170" height="30"><div class="">标题</div></td>
						<td class=""><div class="">
					...
					<tr height="30">
						<td class="InputAreaBg" colspan="2" align="center">
							<input type="image" height="29px" src="${pageContext.request.contextPath}/style/images/2.jpg" style="margin-right:15px;"/>
